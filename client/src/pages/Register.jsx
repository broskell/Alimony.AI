...
export default function Register() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4 py-12" style={{ background: 'var(--bg-base)' }}>
      <div className="w-full max-w-lg rounded-xl border p-8 shadow-2xl transition-all duration-300" style={{ background: 'var(--bg-card)', borderColor: 'var(--border-subtle)' }}>
        {/* Header */}
        <div className="text-center">
          ...
          <h1 className="mt-4 text-2xl font-bold" style={{ color: 'var(--text-primary)' }}>Create Account</h1>
          <p className="mt-1 text-xs" style={{ color: 'var(--text-secondary)' }}>Get analytical matrimonial law guidance in minutes</p>
        </div>
        ...
        <div className="mt-8 flex items-center justify-between">
          {[
            ...
            <div key={s.num} className="flex flex-1 items-center">
              ...
              {index < 2 && (
                <div 
                  className="h-[1px] flex-1 bg-neutral-800 transition-all duration-300"
          ...
          <div className="flex gap-4 pt-4">
            {step > 1 && (
              <button
                type="button"
                onClick={handleBack}
                className="btn-ghost flex-1 rounded-lg py-3 text-sm font-medium transition-colors hover:bg-neutral-800/40"
              >
                Back
              </button>
            )}
            ...
            {step < 3 ? (
              <button
                type="button"
                onClick={handleNext}
                className="btn-primary flex-1 rounded-lg py-3 text-sm font-medium"
              >
                Continue
              </button>
            ) : (
              <button
                type="submit"
                disabled={loading}
                className="btn-primary flex-1 rounded-lg py-3 text-sm font-medium disabled:opacity-50"
              >
        ...
        {step === 1 && (
          <div className="mt-6 space-y-4">
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-lg border px-4 py-3 text-sm font-semibold transition-all hover:bg-neutral-900/55"
